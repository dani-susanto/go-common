...
func (r *http) MiddlewareStack(xs ...Middleware) Middleware {
...
func (s *http) Authenticated(next gohttp.Handler) gohttp.Handler {
	return gohttp.HandlerFunc(func(w gohttp.ResponseWriter, r *gohttp.Request) {
...
func (s *http) Role(roles ...string) Middleware {
	return func(next gohttp.Handler) gohttp.Handler {
		return gohttp.HandlerFunc(func(w gohttp.ResponseWriter, r *gohttp.Request) {
...
func (s *http) GlobalRateLimiter(next gohttp.Handler) gohttp.Handler {
	return gohttp.HandlerFunc(func(w gohttp.ResponseWriter, r *gohttp.Request) {
		ctx := r.Context()
...
func (s *http) ExcludeGlobalRateLimiter(method string, path string) Middleware {
...
func (s *http) RateLimiter(limit int, duration string) Middleware {
	return func(next gohttp.Handler) gohttp.Handler {
		return gohttp.HandlerFunc(func(w gohttp.ResponseWriter, r *gohttp.Request) {
			ctx := r.Context()
